...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.provision :puppet do |puppet|
    ...
    puppet.facter = { newrelic_license_key: ENV['NEWRELIC_LICENSE_KEY'], rvm_version: '1.26.3', ruby_version: '2.1.5', authorized_keys: 'ssh-rsa  calinoiu.alexandru@agilefreaks.com
